...
public class PdfGenerator {
    ...
    private static final float COMPANY_DETAILS_BOTTOM = 160;
    ...
    public static File generateTestPdf(
        ...
        canvas.drawText(
                "Bhumi Complex Near Dakshewar Mahadev Mandir",
                LEFT + 4,
                94,
                paint
        );
...
// Reset after drawing line
        ...
        canvas.drawText("LR. No", invoiceDivision + 4, 124, paint);
        canvas.drawText("LR Date", invoiceDivision + 4, 139, paint);
        canvas.drawText("Transporter", invoiceDivision + 4, 154, paint);
        canvas.drawText("Vehicle No.", invoiceDivision + 4, 169, paint);

// Email in Company Details
...
// Bottom border of company section
        drawStrongLine(
                canvas,
                paint,
                LEFT,
